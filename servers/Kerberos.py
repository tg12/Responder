    ...
    if MsgType == "\x0a" and EncType == "\x17" and MessageType == "\x02":
        if Data[49:53] == "\xa2\x36\x04\x34" or Data[49:53] == "\xa2\x35\x04\x33":
            ...
            if HashLen == 54:
                ...
                DomainLen = struct.unpack(
                    '<b', Data[154 + NameLen + 3:154 + NameLen + 4])[0]
                Domain = Data[154 + NameLen + 4:154 + NameLen + 4 + DomainLen]
                BuildHash = "$krb5pa$23$" + Name + "$" + \
                    Domain + "$dummy$" + SwitchHash.encode('hex')
                return BuildHash
        ...
        if Data[44:48] == "\xa2\x36\x04\x34" or Data[44:48] == "\xa2\x35\x04\x33":
            ...
            if HashLen == 53:
                ...
                DomainLen = struct.unpack(
                    '<b', Data[148 + NameLen + 3:148 + NameLen + 4])[0]
                ...
                DomainLen = struct.unpack(
                    '<b', Data[149 + NameLen + 3:149 + NameLen + 4])[0]
    ...
    if MsgType == "\x0a" and EncType == "\x17":
        if Data[40:44] == "\xa2\x36\x04\x34" or Data[40:44] == "\xa2\x35\x04\x33":
            ...
            if HashLen == 54:
                ...
                DomainLen = struct.unpack(
                    '<b', Data[145 + NameLen + 3:145 + NameLen + 4])[0]
                ...
                DomainLen = struct.unpack(
                    '<b', Data[144 + NameLen + 3:144 + NameLen + 4])[0]
            ...
            DomainLen = struct.unpack(
                '<b', Data[150 + NameLen + 3:150 + NameLen + 4])[0]
